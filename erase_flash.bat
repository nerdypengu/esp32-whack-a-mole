...
echo ---------------------------------------------------
echo 1. Erasing ESP32 Flash Memory...
echo ---------------------------------------------------
idf.py -p %COM_PORT% -b 115200 erase-flash

echo ---------------------------------------------------
echo 2. Flashing Blank Screen Program (painting OLED black)...
echo ---------------------------------------------------
...
echo ===================================================
echo SUCCESS! 
echo - ESP32 flash memory erased.
echo - Blank screen program installed (OLED is now 100%% black).
echo ===================================================
endlocal
